...
public class AddToCart {
	...
	public void clickOnActivePlayOption() 
	{
		...
		} //used for to skip the first element found instead of for each
		for(int i=0;i<subListOfShopAllMenuOptions.size();i++)
		{
		 System.out.println(i+" "+(subListOfShopAllMenuOptions.get(i)).getText());
		 Select dropdown= new select (subListOfShopAllMenuOptions.get(i));
